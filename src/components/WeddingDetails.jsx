...
{showMap && (
  <div style={{ marginTop: "10px" }}>
    ...
    <a
      ...
      rel="noopener noreferrer"
      className="btn map-btn"
      style={{ marginLeft: "10px", background: "#25D366", color: "white" }}
    >
      WhatsApp RSVP
    </a>
  </div>
...
return ( <section className="wedding-details section-padding" id="events"> <KolamCorners size={80} opacity={0.35} offset={12} />
