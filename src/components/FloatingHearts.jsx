...
/**
 * FloatingHearts — renders random floating wireframe hearts with "JP" inside.
            ...
            {particles.map((p, i) => (
                ...
                >
                    <svg className="heart-svg" width="100%" height="100%" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" style={{ overflow: 'visible', filter: 'drop-shadow(0 2px 4px rgba(0,0,0,0.3))' }}>
                        ...
                        <text x="12" y="14.5" textAnchor="middle" fontSize="6.5" fontWeight="bold" fill="currentColor" stroke="none" style={{ fontFamily: 'Playfair Display, serif' }}>JP</text>
